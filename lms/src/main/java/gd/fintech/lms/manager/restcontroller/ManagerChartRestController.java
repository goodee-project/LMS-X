...
public class ManagerChartRestController {
	...
	// 학생별 별점 점수
	@GetMapping("auth/manager/chart/studentStarRatingScore/{lectureNo}")
	public List<Map<String, Object>> studentStarRatingScore(
			@PathVariable(name="lectureNo")int lectureNo){
		return managerChartRestService.selectStudentStarRatingScore(lectureNo);
	}
}
