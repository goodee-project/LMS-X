...
<head>
	...
	<title>studentForgotIdAndPassword</title>
	<!-- Favicon -->
	...
	$(document).ready(function(){
		...
		$('#btn').click(function() {
			...
			$.ajax({
				url : '${pageContext.request.contextPath}/student/forgotCheck/'+$('#email').val()+'/'+$('#name').val()+'/'+$('#phone').val(), 
				type : 'get',
				...
				<div class="col-lg-7 col-md-7">
					<div class="card bg-secondary shadow border-0">
						<div class="card-header bg-transparent pb-5">
							<form id="studentForm" method="post" action="${pageContext.request.contextPath}/forgotIdAndPassword">
								<input type="text" hidden="hidden" name="level" value="1">
								<!-- 이메일 -->
