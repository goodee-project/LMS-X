...
<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
	<div class="container-fluid">
		...
		<!-- Brand -->
		<a class="navbar-brand pt-0" href="${pageContext.request.contextPath}/auth/student/index/1">
		...
		<div class="collapse navbar-collapse" id="sidenav-collapse-main">
			...
			<ul class="navbar-nav">
				<!-- 학생 Index -->
				<li class="nav-item">
					<a class="nav-link" href="${pageContext.request.contextPath}/auth/student/index/1"> <i
				...
				<!-- 수강 신청 -->
				<li class="nav-item">
					<a class="nav-link" href="${pageContext.request.contextPath}/auth/student/lecture/lectureList/1">
				...
				<!-- LMS 공지사항 -->
				<li class="nav-item">
					<a class="nav-link" href="${pageContext.request.contextPath}/auth/student/lmsNotice/lmsNoticeList/1">
				...
				<!-- 시스템 FAQ -->
				<li class="nav-item">
					<a class="nav-link" href="${pageContext.request.contextPath}/auth/student/faq/faqList/1">
