...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<button type="button" class="btn btn-primary" onclick="location.href='${pageContext.request.contextPath}/auth/teacher/lecture/${lectureNo}/test/multiplechoiceList/1'">객관식 문제 관리</button>
