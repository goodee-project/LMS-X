...
<html>
	<head>
		...
		<title>insertReportSubmit</title>
				...
				<div class="row">
					<div class="col">
						<div class="card shadow">
							<form method="post" action="${pageContext.request.contextPath}/auth/teacher/lecture/${lectureNo}/report/reportOne/${reportNo}/insertReportSubmit/${reportSubmitNo}" id="reportSubmitForm">
								<div class="card-header bg-white border-0">
									<div class="row align-items-center">
										<br>
										<div class="col-8">
											<h3 class="mb-0">과제 평가 입력</h3>
										</div>
								...
								<div class="table-responsive">
									<table class="table align-items-center table-flush">
										<tr>
											<th width="20%">점수</th>
											<td width="80%">
												<input type="number" class="form-control" name="reportSubmitPoint" id="reportSubmitPoint">
										...
										<tr>
											<th>평가 내용</th>
											<td>
												<input type="text" class="form-control" name="reportSubmitFeedback" id="reportSubmitFeedback">
