...
<nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
	<div class="container-fluid">
		<ul class="navbar-nav mr-auto">
			<!-- 쪽지 수신함 -->
			<li class="nav-item">
		    	<a class="nav-link" href="${pageContext.request.contextPath}/auth/teacher/note/noteReceiveList/1">쪽지 수신함</a>
		    </li>
		    
		    <!-- 쪽지 발신함 -->
		    <li class="nav-item">
		    	<a class="nav-link" href="${pageContext.request.contextPath}/auth/teacher/note/noteDispatchList/1">쪽지 발신함</a>
		    </li>
		    
		    <!-- 쪽지 보내기 -->
		    <li class="nav-item">
		    	<a class="nav-link" href="${pageContext.request.contextPath}/auth/teacher/note/insertNote">쪽지 보내기</a>
		    </li>
		</ul>
		<!-- User -->
