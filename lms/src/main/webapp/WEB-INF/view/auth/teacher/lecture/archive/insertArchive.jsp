...
<html>
	...
	<div class="main-content">
		...
		<div class="container-fluid mt--7">
			<!-- Form -->
			<form method="post"
				action="${pageContext.request.contextPath}/auth/teacher/lecture/${lectureNo}/archive/insertArchive"
				enctype="multipart/form-data" id="lectureArchiveForm">
				<!-- Table -->
				<div class="row">
					<div class="col">
