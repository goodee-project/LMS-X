						...
						<div class="card-header bg-white border-0">
							<div class="row align-items-center">
								...
								<div class="col-4 text-right">
									<button type="button" class="btn btn-sm btn-success" id="updateBtn">입력</button>
						...
						<div class="table-responsive">
							<table class="table align-items-center table-flush">
								...
								<tr>
									<td>내용</td>
									<td>
										<textarea class="form-control" rows="22" name="lectureNoticeContent" id="lectureNoticeContent">${lectureNotice.lectureNoticeContent}</textarea>
									</td>
								</tr>
							</table>
						</div>
