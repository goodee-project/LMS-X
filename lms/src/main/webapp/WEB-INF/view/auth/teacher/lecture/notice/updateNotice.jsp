...
<body class="">
	...
	<div class="main-content">
		...
		<div class="container-fluid mt--7">
			<!-- Form -->
			<form method="post"
				action="${pageContext.request.contextPath}/auth/teacher/lecture/${lectureNo}/notice/updateNotice/${lectureNoticeNo}"
				id="updateNoticeForm">
				<!-- Table -->
				<div class="row">
					<div class="col">
								...
								<div class="row align-items-center">
									...
									<div class="col-4 text-right">
										<button type="button" class="btn btn-sm btn-success"
											id="updateBtn">입력</button>
										<button type="button" class="btn btn-sm btn-dark"
											onclick="location.href='${pageContext.request.contextPath}/auth/teacher/lecture/${lectureNo}/notice/noticeOne/${lectureNoticeNo}'">목록</button>
									</div>
									<br>
								</div>
							</div>
								...
								<table class="table align-items-center table-flush">
									<tr>
										...
										<td style="width: 80%"><input type="text"
											class="form-control" value="${lectureNotice.lectureNoticeNo}"
											readonly="readonly"></td>
									</tr>
									<tr>
										<td>제목</td>
										<td><input type="text" class="form-control"
											value="${lectureNotice.lectureNoticeTitle}"
											name="lectureNoticeTitle" id="noticeTitleText"></td>
									</tr>
									<tr>
										<td>내용</td>
										<td><textarea class="form-control" rows="22"
												name="lectureNoticeContent" id="lectureNoticeContent">${lectureNotice.lectureNoticeContent}</textarea>
										</td>
									</tr>
								</table>
							</div>
