										...
										<c:if test="${multiplechoiceList[0].multiplechoiceNo != null}">
											<c:forEach var="mcl" items="${multiplechoiceList}">
												<tr>
													...
													<td>
														<button type="button" class="btn btn-sm btn-success" onclick="location.href='${pageContext.request.contextPath}/auth/teacher/lecture/${lectureNo}/test/multiplechoiceExampleList/${mcl.multiplechoiceNo}'">보기 관리</button>
													</td>
													<td>
