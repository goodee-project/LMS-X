				...
				<div class="card shadow">
					...
					<div class="row align-items-center">
						<div class="col-12">
							...
							<div style="text-align: right;"><a class="btn btn-outline-primary" href="${pageContext.request.contextPath }/auth/manager/subject/insertSubject">과목 추가</a></div>
							<!-- 페이지 네비게이션 -->
