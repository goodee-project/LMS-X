				...
				<div class="row">
					<div class="col">
						<div class="card shadow">
							<form method="post" id="classroomForm"	action="${pageContext.request.contextPath}/auth/manager/classroom/updateClassroom">
								<div class="card-header bg-white border-0">
									<div class="row align-items-center">
										<br>
										<div class="col-8">
											<h3 class="mb-0">강의실 수정</h3>
										</div>
										<div class="col-4 text-right">
											<button type="button" class="btn btn-sm btn-dark"
												onclick="location.href='${pageContext.request.contextPath}/auth/manager/classroom/classroomList/1'">목록</button>
											<button type="button" id="classroomBtn" class="btn btn-sm btn-primary">수정</button>
										</div>
										<br>
									</div>
								</div>
								...
								<div class="table-responsive">
									<table class="table align-items-center table-flush">
										...
										<tr>
											<th>강의실 호실</th>
											<td>
												<input type="number" class="form-control" name="classroomNo"value="${classroom.classroomNo}" hidden="hidden">
												<input type="number" class="form-control" name="classroomNumber" value="${classroom.classroomNumber}" id="classroomNumber">
											</td>
										</tr>
										<tr>
											<th>강의실 사이즈</th>
											<td><input type="number" class="form-control" name="classroomSize" value="${classroom.classroomSize}" id="classroomSize"></td>
										</tr>
										<tr>
											<th>강의실 최대 인원</th>
											<td><input type="number" class="form-control" name="classroomTotal" value="${classroom.classroomTotal}" id="classroomTotal"></td>
										</tr>
									</table>
								</div>
							</form>
