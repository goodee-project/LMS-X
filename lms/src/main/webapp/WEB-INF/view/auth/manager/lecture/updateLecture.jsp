...
<body>
	...
	<h1>강의 수정</h1>
	<a
		href="${pageContext.request.contextPath}/auth/manager/lecture/lectureOne/${lectureNo}">뒤로가기</a>
	<form method="post"
		action="${pageContext.request.contextPath}/auth/manager/lecture/updateLecture/${lectureNo}"
		id="updateLectureForm">
		<table border="1">
			<tr>
				<td>강의 번호</td>
				<td><input type="text" name="lectureNo" value="${lectureNo}"
			...
			<tr>
				<td>강사 명</td>
				<td><input type="text" name="teacherName" id="teacherNametext"
					value="${lct.lecture.teacherName}"></td>
			</tr>
			<tr>
				<td>강의 명</td>
				<td><input type="text" name="lectureName" id="lectureNametext"
					value="${lct.lecture.lectureName}"></td>
			</tr>
			<tr>
				<td>교재</td>
				<td><select name="textbookIsbn">
