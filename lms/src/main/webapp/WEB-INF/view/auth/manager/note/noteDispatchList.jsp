...
<body>
	...
	<div class="main-content">
		...
		<div class="container-fluid">
			<jsp:include page="/WEB-INF/view/auth/manager/include/noteMenu.jsp" />
		</div>
						...
						<div class="table-responsive">
							<table class="table align-items-center table-flush">
								...
								<tbody>
									...
									<c:if test="${empty noteList[0].noteNo}">
										<tr>
											<td colspan="4">(현재 보낸 쪽지가 없습니다.)</td>
										</tr>
									</c:if>
								</tbody>
							</table>
							...
							<nav aria-label="...">
								...
								<ul class="pagination justify-content-center">
									...
									<c:choose>
										<c:when test="${currentPage > 1}">
											<li class="page-item"><a class="page-link"
												href="${pageContext.request.contextPath}/auth/manager/note/noteDispatchList/1">
									...
									<c:choose>
										<c:when test="${currentPage > 1}">
											<li><a
												href="${pageContext.request.contextPath}/auth/manager/note/noteDispatchList/${prePage}">
									...
									<c:forEach var="i" begin="${navFirstPage}" end="${navLastPage}">
										<c:if test="${i <= lastPage}">
											<c:choose>
												...
												<c:otherwise>
													<li class="page-item"><a class="page-link"
														href="${pageContext.request.contextPath}/auth/manager/note/noteDispatchList/${i}">${i}</a>
													</li>
												</c:otherwise>
											</c:choose>
										</c:if>
									...
									<c:choose>
										<c:when test="${currentPage < lastPage}">
											<li><a
												href="${pageContext.request.contextPath}/auth/manager/note/noteDispatchList/${nextPage}">
									...
									<c:choose>
										<c:when test="${currentPage < lastPage}">
											<li class="page-item"><a class="page-link"
												href="${pageContext.request.contextPath}/auth/manager/note/noteDispatchList/${lastPage}">
