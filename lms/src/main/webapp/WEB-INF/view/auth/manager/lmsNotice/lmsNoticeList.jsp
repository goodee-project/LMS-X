								...
								<tbody>
									<c:forEach var="lnl" items="${lmsNoticeList}">
										<tr>
											...
											<td><a
												href="${pageContext.request.contextPath}/auth/manager/lmsNotice/lmsNoticeOne/${lnl.lmsNoticeNo}">${lnl.lmsNoticeTitle}</a></td>
							...
							<nav aria-label="...">
								<ul class="pagination justify-content-center">
									...
									<c:choose>
										<c:when test="${currentPage > 1}">
											<li class="page-item"><a class="page-link"
												href="${pageContext.request.contextPath}/auth/manager/lmsNotice/lmsNoticeList/1">
									...
									<c:choose>
										<c:when test="${currentPage > 1}">
											<li class="page-item"><a class="page-link"
												href="${pageContext.request.contextPath}/auth/manager/lmsNotice/lmsNoticeList/${prePage}">
									...
									<c:forEach var="i" begin="${navFirstPage}" end="${navLastPage}">
										<c:if test="${i <= lastPage}">
											<c:choose>
												...
												<c:otherwise>
													<li class="page-item"><a class="page-link"
														href="${pageContext.request.contextPath}/auth/manager/lmsNotice/lmsNoticeList/${i}">${i}</a>
													</li>
												</c:otherwise>
											</c:choose>
										</c:if>
									...
									<c:choose>
										<c:when test="${currentPage < lastPage}">
											<li class="page-item"><a class="page-link"
												href="${pageContext.request.contextPath}}/auth/manager/lmsNotice/lmsNoticeList/${nextPage}">
									...
									<c:choose>
										<c:when test="${currentPage < lastPage}">
											<li class="page-item"><a class="page-link"
												href="${pageContext.request.contextPath}}/auth/manager/lmsNotice/lmsNoticeList/${lastPage}">
