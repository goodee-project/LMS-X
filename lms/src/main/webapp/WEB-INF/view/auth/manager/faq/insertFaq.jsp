						...
						<form method="post"
							...
							<div class="table-responsive">
								<table class="table align-items-center table-flush">
									<tr>
										<th width="20%">제목</th>
										<td width="80%"><input type="text" class="form-control" name="faqTitle" id="faqTitle"></td>
									</tr>
									<tr>
										<th>카테고리</th>
									...
									<tr>
										<th>내용</th>
										<td>
											<textarea name="faqContent" rows="10" cols="22" class="form-control" id="faqContent" style="width: 100%;"></textarea>
										</td>
									</tr>
