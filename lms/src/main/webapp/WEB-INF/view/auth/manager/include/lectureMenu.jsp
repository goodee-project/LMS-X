...
<nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
	<div class="container-fluid">
		<ul class="navbar-nav mr-auto">
			 <!-- 자료실 페이지 -->
		    <li class="nav-item">
		    	<a class="nav-link" href="${pageContext.request.contextPath}/auth/manager/lecture/${lectureNo}/archive/archiveList/1">자료실</a>
		    </li>
		     <!-- 질문 게시판 페이지 -->
		    <li class="nav-item">
		    	<a class="nav-link" href="${pageContext.request.contextPath}/auth/manager/lecture/${lectureNo}/question/questionList/1">질문 게시판</a>
		    </li>
		    <!-- 수강 학생 관리 페이지 -->
		    <li class="nav-item">
		    	<a class="nav-link" href="${pageContext.request.contextPath}/auth/manager/lecture/${lectureNo}/studentManagement">수강 학생 관리</a>
		    </li>
		</ul>
		<!-- User -->
