							...
							<div class="card-header bg-white border-0">
								<div class="row align-items-center">
									...
									<div class="col-4 text-right">
										<button type="button" class="btn btn-sm btn-dark" onclick="location.href='${pageContext.request.contextPath}/auth/manager/lecture/${lectureNo}/archive/archiveList/1'">목록</button>
										...
										<div class="modal-dialog modal-danger modal-dialog-centered modal-"
											...
											<div class="modal-content bg-gradient-danger">
												...
												<div class="modal-footer">
													...
													<button type="button" class="btn btn-link text-white ml-auto" onclick="location.href='location.href='${pageContext.request.contextPath}/auth/manager/lecture/${lectureNo}/archive/archiveOne/deleteArchive/${lectureArchiveNo}'">삭제</button>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="table-responsive">
								<table class="table align-items-center table-flush">
									<tr>
										...
										<td width="40%">${lectureArchive.lectureArchiveNo}</td>
										<th width="10%">조회수</th>
										<td width="40%">${lectureArchive.lectureArchiveCount}</td>
									</tr>
									<tr>
										<th>작성일시</th>
									...
									<tr>
										<th>작성자</th>
										<td colspan="3">${lectureArchive.lectureArchiveWriter}</td>
									</tr>
									<tr>
										<th>제목</th>
										<td colspan="3">${lectureArchive.lectureArchiveTitle}</td>
									</tr>
									<tr>
										<th>내용</th>
										<td colspan="3">${lectureArchive.lectureArchiveContent}</td>
									</tr>
									<tr>
										<th>첨부파일</th>
										<td colspan="3">
