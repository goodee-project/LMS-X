								...
								<div class="row align-items-center">
									...
									<div class="col-4 text-right">
										<button type="button" class="btn btn-sm btn-success"
											onclick="location.href='${pageContext.request.contextPath }/auth/manager/classroom/insertClassroom'">추가</button>
									</div>
									<br>
								</div>
							</div>
														...
														<div class="modal-dialog modal-danger modal-dialog-centered modal-"
															...
															<div class="modal-content bg-gradient-danger">
																...
																<div class="modal-footer">
																	...
																	<button type="button" class="btn btn-link text-white ml-auto" onclick="location.href='${pageContext.request.contextPath}/auth/manager/classroom/deleteClassroom/${cr.classroomNo}'">삭제</button>
																</div>
															</div>
														</div>
													</div>
								...
								<nav aria-label="...">
									...
									<ul class="pagination justify-content-center">
										...
										<c:choose>
											<c:when test="${currentPage > 1}">
												<li class="page-item"><a class="page-link"
													href="${pageContext.request.contextPath}/auth/manager/classroom/classroomList/1">
										...
										<c:choose>
											<c:when test="${currentPage > 1}">
												<li class="page-item"><a class="page-link"
													href="${pageContext.request.contextPath}/auth/manager/classroom/classroomList/${prePage}">
										...
										<c:forEach var="i" begin="${navFirstPage}" end="${navLastPage}">
											<c:if test="${i <= lastPage}">
												<c:choose>
													...
													<c:otherwise>
														<li class="page-item"><a class="page-link"
															href="${pageContext.request.contextPath}/auth/manager/classroom/classroomList/${i}">${i}</a>
														</li>
													</c:otherwise>
												</c:choose>
											</c:if>
										...
										<c:choose>
											<c:when test="${currentPage < lastPage}">
												<li class="page-item"><a class="page-link"
													href="${pageContext.request.contextPath}/auth/manager/classroom/classroomList/${nextPage}">
										...
										<c:choose>
											<c:when test="${currentPage < lastPage}">
												<li class="page-item"><a class="page-link"
													href="${pageContext.request.contextPath}/auth/manager/classroom/classroomList/${lastPage}">
