...
<script>
	$(document).ready(function(){
		...
		$('#searchAccountBtn').click(function(){
			...
			// 계정 리스트 가져오기
			$.ajax({
				url: '${pageContext.request.contextPath}/auth/manager/note/accountList/' + $('#searchAccountText').val(),
				type:'get',
			...
			<div class="row">
				<div class="col">
					<div class="card shadow">
						<form id="insertNoteForm" method="post"
							action="${pageContext.request.contextPath}/auth/manager/note/insertNote">
										...
										<td>
											<div class="input-group">
												...
												<div class="input-group-append">
													<button type="button" id="searchAccountBtn"
														class="btn btn-primary">검색</button>
												</div>
											</div>
											<div id="selectAccount"
												style="overflow: auto; width: 100%; max-height: 200px;">
