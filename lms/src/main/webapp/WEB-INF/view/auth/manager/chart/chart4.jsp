		...
		<script>
			$(document).ready(function() {
				function showChart() {
					...
					$.ajax({
						url : '${pageContext.request.contextPath}/auth/manager/chart/reportSubmissionRateByLecture/'+$('#lecture').val(),
						type : 'get',
						success : function(data){
							...
							if(data.length > 0){
								...
								$(data).each(function(key, value) {
									...
									myChart.data.datasets[0].data.push(value.submissionRate);
